...
class Packager {
    ...
    constructor(options, cancellationToken = new (_builderUtilRuntime || _load_builderUtilRuntime()).CancellationToken()) {
        ...
        try {
            (0, (_builderUtil || _load_builderUtil()).log)("electron-builder " + "19.48.3");
        } catch (e) {
    ...
    build() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if ((_builderUtil || _load_builderUtil()).debug.enabled) {
                (0, (_builderUtil || _load_builderUtil()).debug)(`Effective config:\n${(0, (_builderUtil || _load_builderUtil()).serializeToYaml)(JSON.parse((0, (_builderUtil || _load_builderUtil()).safeStringifyJson)(configuration)))}`);
            }
            _this._appDir = yield (0, (_config || _load_config()).computeDefaultAppDirectory)(projectDir, (0, (_builderUtil || _load_builderUtil()).use)(configuration.directories, function (it) {
                return it.app;
            }));
    ...
    _build(configuration, metadata, devMetadata, repositoryInfo) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const outDir = _path.resolve(_this2.projectDir, (0, (_builderUtil || _load_builderUtil()).use)(_this2.config.directories, function (it) {
                return it.output;
            }) || "dist");
            return {
                outDir,
